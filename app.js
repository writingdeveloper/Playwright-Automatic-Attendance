...
async function start() {
    ...
    await page.waitForSelector('#fo_member_login > fieldset > div:nth-child(2) > input.app-button.app-button-expand.primary')
    await page.click('#fo_member_login > fieldset > div:nth-child(2) > input.app-button.app-button-expand.primary')
